$(document).ready(() => {
  ...
  function showOnScroll(mySection) {
    if (
      $(window).scrollTop() >=
      mySection.offset().top - $(window).height() / 3
    ) {
  ...
  //   $(".experiences .right ul li").hover(
  //     function () {
  //       $(this).find(".full-skills").fadeIn(500);
  //     },
  //     function () {
  //       $(this).find(".full-skills").fadeOut(200);
  //     }
  //   );
  ...
  $(".scroll-to-section").click(function (e) {
    ...
    if ($(window).width() < 900) $(".mobile-nav").removeClass("show-navbar");
    $("html, body").animate(
      {
